...
<body>
<div id="msg"><%=session.getAttribute("userid")%> : ${model.firstName} : ${model.userType} : ${model.loginStatus}</div>

<div id="searchform" >
<form:form action="search" modelAttribute="userDetails" style="border:1px solid #ccc;width:50%" method="post">
  <div class="container">
    <h1>Search</h1>
...
<a href="problemStatement">Add Topic</a><br>
