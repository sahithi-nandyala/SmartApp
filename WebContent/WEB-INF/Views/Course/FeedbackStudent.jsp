...
<p class="goback"><a href='<%=session.getAttribute("assignid")%>'>Back to my assignments</a></p>
<br>
<p class="heading2a">
...
<svg xmlns="http://www.w3.org/2000/svg" style="position:relative; max-width:100%; max-height:90%;"></svg>
	<script src="http://d3js.org/d3.v4.min.js"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/d3-tip/0.7.1/d3-tip.min.js"></script>
</div>
