...
function submitallconcepts()
{
	var KeyConcepts=[];
	var basicConcepts=[];
	var ol1 = document.getElementById("key");
	var items1 = ol1.getElementsByTagName("li");
	for (var i = 0; i < items1.length; ++i) {
		KeyConcepts[i]=items1[i].innerHTML;
	}
	var ol2 = document.getElementById("basic");
	var items2 = ol2.getElementsByTagName("li");
	for (var i = 0; i < items2.length; ++i) {
		basicConcepts[i]=items2[i].innerHTML;
	}
	var id=document.getElementById("expertid").value;
	...
	$.ajax({
	    ...
	    success : function(response) {
	       alert("Saved");
	       document.getElementById('feedbacksubmit').submit();
	    },
	    error : function(e) {
	       alert("Saved");
	       document.getElementById('feedbacksubmit').submit();
...
$(function() {
	...
	$("#addsynonyms").click(function(){
		$("#synonymtable").slideToggle("slow");
	});
	
	$(".horizontal > input:button").click(function(){
		$(this).before("<input type='text'>");
		
	});
	
/*	$("#vertical > input:button").click(function(){
		$(this).parent().before("<p class='horizontal'><input type='text' /> : <input type='button'  value='+'/></p>");
...
/*function addsynonym(e)
{
	...
	node.appendChild("sjhdjshdg");
	//$("#horizontal").append("<input type='text'>");
}

function addconcept()
{
	$("#vertical").prepend("<input id='synonyms' type='text' /> : <span id='horizontal'><input type='button' onClick='addsynonym(event)' value='+'/></span>
	");
}
}*/